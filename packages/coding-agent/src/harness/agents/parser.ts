...
import { type Agent, type GrantValue, isReasoningVariant, type ToolDecision, type ToolGrants } from './types';
...
export const parseAgent = (source: string, fallbackName: string): Agent => {
  ...
  return {
    ...
    variant: isReasoningVariant(fields.variant) ? fields.variant : undefined,
